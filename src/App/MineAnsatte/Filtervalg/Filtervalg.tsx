...
const Filtervalg: FunctionComponent<Props> = props => {
    ...
    const arrayMedToggleAntall = [
        '(' + props.overSiktOverAntallAktiveOgInaktive[0] + ')',
        '(' + props.overSiktOverAntallAktiveOgInaktive[1].toString() + ')',
        `(${props.overSiktOverAntallAktiveOgInaktive[2].toString()})`
    ];
    */
    return (
