    ...
    return (
        <div>
            ...
            <Popover ankerEl={anker}>
                <div style={{padding: '1rem 1rem 0 1rem '}}>  {props.varsler.map(varsel => <div key={varsel.varslingskode} style={{padding: '0 0 1rem 0'}}>{varsel.varslingskodeForklaring}</div>)}</div>
            </Popover>
        </div>
    );
};
