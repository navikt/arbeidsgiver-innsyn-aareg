...
var cls = function cls(className) {
  return classNames('skjemaelement skjemaelement--horisontal', className);
};
var inputCls = function inputCls(harFeil) {
  return classNames('skjemaelement__input checkboks', {
