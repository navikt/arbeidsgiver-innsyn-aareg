...
var inputCls = function inputCls(harFeil) {
  return classNames('skjemaelement__input', {
    'skjemaelement__input--harFeil': harFeil
  });
};
var selectCls = function selectCls(bredde) {
  return classNames('selectContainer', "input--" + bredde);
};
/**
 * Select
 */
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ["children", "bredde", "disabled", "className", "label", "id", "feil", "selectRef"]);

      var inputId = id || nav_frontend_js_utils_1.guid();
      return React.createElement("div", { className: cls(className) }, React.createElement("label", { className: "skjemaelement__label", htmlFor: inputId }, label), React.createElement("div", { className: selectCls(bredde) }, React.createElement("select", Object.assign({ id: inputId, className: inputCls(feil), ref: selectRef, disabled: disabled }, other), children)), React.createElement(skjemaelement_feilmelding_1.default, { feil: feil }));
    }
  }]);
