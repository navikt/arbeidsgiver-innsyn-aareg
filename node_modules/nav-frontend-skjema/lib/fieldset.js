...
var cls = function cls(className) {
    return classNames('skjema__fieldset', className);
};
/**
 * Fieldset
 */
    ...
    _createClass(Fieldset, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                other = _objectWithoutProperties(_props, ["children", "className", "legend"]);

            return React.createElement("fieldset", Object.assign({ className: cls(className) }, other), React.createElement("legend", { className: "skjema__legend" }, legend), children);
        }
    }]);
