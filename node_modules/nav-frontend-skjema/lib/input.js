...
var inputClass = function inputClass(width, className, harFeil) {
  return classNames('skjemaelement__input', className, "input--" + width.toLowerCase(), { 'skjemaelement__input--harFeil': harFeil });
};
/**
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ["label", "bredde", "feil", "id", "name", "inputRef", "className", "inputClassName"]);

      var inputId = id || name || nav_frontend_js_utils_1.guid();
      return React.createElement("div", { className: cls(className) }, React.createElement("label", { className: "skjemaelement__label", htmlFor: inputId }, label), React.createElement("input", Object.assign({ type: "text", className: inputClass(bredde, inputClassName, feil), id: inputId, name: name }, other, { ref: inputRef })), React.createElement(skjemaelement_feilmelding_1.default, { feil: feil }));
    }
  }]);
