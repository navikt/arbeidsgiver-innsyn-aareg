...
var HjelpetekstOver = function (_React$Component) {
    _inherits(HjelpetekstOver, _React$Component);

    function HjelpetekstOver() {
        _classCallCheck(this, HjelpetekstOver);

        return _possibleConstructorReturn(this, (HjelpetekstOver.__proto__ || Object.getPrototypeOf(HjelpetekstOver)).apply(this, arguments));
    }

    _createClass(HjelpetekstOver, [{
        key: "render",
        value: function render() {
            return React.createElement(hjelpetekst_1.default, Object.assign({ type: "over" }, this.props));
        }
    }]);

    return HjelpetekstOver;
}(React.Component);

exports.default = HjelpetekstOver;
HjelpetekstOver.__docgenInfo = {"description":"","displayName":"HjelpetekstOver","props":{"children":{"defaultValue":null,"description":"Innholdet i hjelpetekst-vinduet","name":"children","required":true,"type":{"name":"ReactNode"}},"id":{"defaultValue":null,"description":"-","name":"id","required":true,"type":{"name":"string"}},"className":{"defaultValue":null,"description":"-","name":"className","required":false,"type":{"name":"string"}},"tittel":{"defaultValue":null,"description":"Tekst som vises ved mouseover","name":"tittel","required":false,"type":{"name":"string"}},"type":{"defaultValue":null,"description":"Posisjon på hjelpetekst-vinduet","name":"type","required":false,"type":{"name":"enum","value":[{"value":"\"auto\""},{"value":"\"over\""},{"value":"\"under\""},{"value":"\"venstre\""},{"value":"\"midt\""},{"value":"\"hoyre\""},{"value":"\"under-venstre\""},{"value":"\"under-hoyre\""}]}},"anchor":{"defaultValue":null,"description":"-","name":"anchor","required":false,"type":{"name":"any"}}}}