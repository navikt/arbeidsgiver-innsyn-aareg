...
var HjelpetekstHoyre = function (_React$Component) {
    _inherits(HjelpetekstHoyre, _React$Component);

    function HjelpetekstHoyre() {
        _classCallCheck(this, HjelpetekstHoyre);

        return _possibleConstructorReturn(this, (HjelpetekstHoyre.__proto__ || Object.getPrototypeOf(HjelpetekstHoyre)).apply(this, arguments));
    }

    _createClass(HjelpetekstHoyre, [{
        key: "render",
        value: function render() {
            return React.createElement(hjelpetekst_1.default, Object.assign({ type: "hoyre" }, this.props));
        }
    }]);

    return HjelpetekstHoyre;
}(React.Component);

exports.default = HjelpetekstHoyre;
HjelpetekstHoyre.__docgenInfo = {"description":"","displayName":"HjelpetekstHoyre","props":{"children":{"defaultValue":null,"description":"Innholdet i hjelpetekst-vinduet","name":"children","required":true,"type":{"name":"ReactNode"}},"id":{"defaultValue":null,"description":"-","name":"id","required":true,"type":{"name":"string"}},"className":{"defaultValue":null,"description":"-","name":"className","required":false,"type":{"name":"string"}},"tittel":{"defaultValue":null,"description":"Tekst som vises ved mouseover","name":"tittel","required":false,"type":{"name":"string"}},"type":{"defaultValue":null,"description":"Posisjon på hjelpetekst-vinduet","name":"type","required":false,"type":{"name":"enum","value":[{"value":"\"auto\""},{"value":"\"over\""},{"value":"\"under\""},{"value":"\"venstre\""},{"value":"\"midt\""},{"value":"\"hoyre\""},{"value":"\"under-venstre\""},{"value":"\"under-hoyre\""}]}},"anchor":{"defaultValue":null,"description":"-","name":"anchor","required":false,"type":{"name":"any"}}}}