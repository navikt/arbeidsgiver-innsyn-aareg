...
require("nav-frontend-lenker-style");
var getRelFromTarget = function getRelFromTarget(target) {
    if (!target || target.toLowerCase() === '_self' || target.toLowerCase() === '_top' || target.toLowerCase() === '_parent') {
        return undefined;
    }
    return 'noopener';
};
var cls = function cls(className) {
    return classnames('lenke', className);
};

var Lenke = function (_React$Component) {
    _inherits(Lenke, _React$Component);

    function Lenke() {
        _classCallCheck(this, Lenke);

        return _possibleConstructorReturn(this, (Lenke.__proto__ || Object.getPrototypeOf(Lenke)).apply(this, arguments));
    }
    ...
    _createClass(Lenke, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = _objectWithoutProperties(_props, ["href", "target", "ariaLabel", "children", "className"]);

            return React.createElement("a", Object.assign({ href: href, target: target, rel: getRelFromTarget(target), className: cls(className), "aria-label": ariaLabel }, rest), children);
        }
    }]);
