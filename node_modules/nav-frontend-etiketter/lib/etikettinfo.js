...
var EtikettInfo = function (_React$Component) {
    _inherits(EtikettInfo, _React$Component);

    function EtikettInfo() {
        _classCallCheck(this, EtikettInfo);

        return _possibleConstructorReturn(this, (EtikettInfo.__proto__ || Object.getPrototypeOf(EtikettInfo)).apply(this, arguments));
    }

    _createClass(EtikettInfo, [{
        key: "render",
        value: function render() {
            return React.createElement(index_1.default, Object.assign({ type: "info" }, this.props));
        }
    }]);
