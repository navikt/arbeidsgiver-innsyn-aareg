...
var EtikettFokus = function (_React$Component) {
    _inherits(EtikettFokus, _React$Component);

    function EtikettFokus() {
        _classCallCheck(this, EtikettFokus);

        return _possibleConstructorReturn(this, (EtikettFokus.__proto__ || Object.getPrototypeOf(EtikettFokus)).apply(this, arguments));
    }

    _createClass(EtikettFokus, [{
        key: "render",
        value: function render() {
            return React.createElement(index_1.default, Object.assign({ type: "fokus" }, this.props));
        }
    }]);
