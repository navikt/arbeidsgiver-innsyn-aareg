...
var Infotekst = function (_React$Component) {
    _inherits(Infotekst, _React$Component);

    function Infotekst() {
        _classCallCheck(this, Infotekst);

        return _possibleConstructorReturn(this, (Infotekst.__proto__ || Object.getPrototypeOf(Infotekst)).apply(this, arguments));
    }

    _createClass(Infotekst, [{
        key: "render",
        value: function render() {
            return React.createElement(index_1.default, Object.assign({ type: "infotekst" }, this.props));
        }
    }]);
