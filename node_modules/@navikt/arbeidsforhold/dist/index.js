...
var fetchMock = _interopDefault(require('fetch-mock'));
var React = require('react');
var React__default = _interopDefault(React);
var AlertStripe = require('nav-frontend-alertstriper');
var AlertStripe__default = _interopDefault(AlertStripe);
var NavFrontendSpinner = _interopDefault(require('nav-frontend-spinner'));
var navFrontendTypografi = require('nav-frontend-typografi');
var navFrontendChevron = require('nav-frontend-chevron');
var moment = _interopDefault(require('moment'));
var Hjelpetekst = _interopDefault(require('nav-frontend-hjelpetekst'));
require('moment/locale/nb');
var Tabs = _interopDefault(require('nav-frontend-tabs'));
var navFrontendSkjema = require('nav-frontend-skjema');
...
var Error = function Error(props) {
  ...
  }, React__default.createElement(AlertStripe__default, {
    type: "feil"
  }, sprak[props.locale].httperror, React__default.createElement("br", null), error && React__default.createElement("span", null, " ".concat(error.code, ": ").concat(error.text))));
};
...
var Spinner = function Spinner() {
  ...
  }, React__default.createElement(NavFrontendSpinner, {
    type: "XL"
  }));
};
...
var CheckAndPrint = function CheckAndPrint(props) {
  return props.data ? React__default.createElement("span", {
    className: props.font
  }, props.format ? parse(props.format, props.data) : props.data) : React__default.createElement(NoData, null);
};

var CheckDateAndPrint = function CheckDateAndPrint(props) {
  if (!props.data) {
    return React__default.createElement(NoData, null);
  }

  var date = moment(props.data).format(props.dateFormat || "DD.MM.YYYY");
  var formattedDate = props.format ? parse(props.format, date) : date;
  return React__default.createElement("span", null, props.maskineltAvsluttet ? React__default.createElement("span", null, React__default.createElement("span", null, formattedDate), React__default.createElement(Hjelpetekst, {
...
var CheckPeriodAndPrint = function CheckPeriodAndPrint(props) {
  return props.data ? React__default.createElement("span", null, React__default.createElement(CheckDateAndPrint, {
    data: props.data.periodeFra,
    dateFormat: props.format
  }), " - ", props.twoLines && React__default.createElement("br", null), React__default.createElement(CheckDateAndPrint, {
    data: props.data.periodeTil,
    dateFormat: props.format,
    maskineltAvsluttet: props.maskineltAvsluttet
  })) : React__default.createElement(NoData, null);
};
...
var ArbeidsgiverTittel = function ArbeidsgiverTittel(props) {
  switch (props.arbeidsgiver.type) {
    case "Person":
      return React__default.createElement(CheckAndPrint, {
...
var ListeTittel = function ListeTittel(props) {
  ...
  switch (_onClick.type) {
    case "INGEN_ON_CLICK":
      return React__default.createElement(ArbeidsgiverTittel, {
    ...
    case "LENKE":
      ...
      }, React__default.createElement(ArbeidsgiverTittel, {
        arbeidsgiver: foretak.arbeidsgiver
      }));

    case "REACT_ROUTER_LENKE":
      return React__default.createElement(_onClick.Component, {
        className: "lenke",
...
var Arbeidsforhold = function Arbeidsforhold(props) {
  ...
  return React__default.createElement("div", {
    ...
    }, React__default.createElement(ListeTittel, {
      foretak: foretak,
      onClick: onClick
    })), React__default.createElement("div", {
      className: "af-liste__tekst"
    }, React__default.createElement(CheckAndPrint, {
      data: foretak.yrke,
      font: "typo-normal"
    })), React__default.createElement("div", {
      className: "af-liste__tekst typo-normal"
    }, React__default.createElement(CheckPeriodAndPrint, {
    ...
    className: "af-liste__flex-rad"
  }, React__default.createElement(navFrontendTypografi.Normaltekst, null, sprak[props.locale].ingenarbeidsforhold))), arbeidsforhold.length > 5 && React__default.createElement("button", {
    className: "af-liste__vis-flere lenke",
    onClick: toggleVisAlle,
    "aria-expanded": visAlle
  }, visAlle ? React__default.createElement(navFrontendTypografi.Normaltekst, null, sprak[props.locale].visfaerrearbeidsforhold, " ", React__default.createElement(navFrontendChevron.OppChevron, null)) : React__default.createElement(navFrontendTypografi.Normaltekst, null, sprak[props.locale].visflerearbeidsforhold, " ", React__default.createElement(navFrontendChevron.NedChevron, null))));
};
...
var ListeMedArbeidsforhold = function ListeMedArbeidsforhold(props) {
  ...
  var _useState = React.useState(persistState),
      _useState2 = _slicedToArray(_useState, 2),
      state = _useState2[0],
  ...
  switch (state.status) {
    ...
    case "RESULT":
      return React__default.createElement(Arbeidsforhold, _extends({
...
var CheckAndPrintBox = function CheckAndPrintBox(props) {
  return props.data ? React__default.createElement("div", {
    className: "af-detaljert__boks"
  }, React__default.createElement(navFrontendTypografi.Element, null, props.title), React__default.createElement(navFrontendTypografi.Normaltekst, null, props.date ? React__default.createElement(CheckDateAndPrint, {
    data: props.data,
    format: props.format
  }) : React__default.createElement(CheckAndPrint, {
    data: props.data,
...
var ArbeidsavtaleFelter = function ArbeidsavtaleFelter(props) {
  var locale = props.locale,
      data = props.data;
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(CheckAndPrintBox, {
    title: sprak[locale].arbeidstidsordning,
    data: data.arbeidstidsordning
  }), React__default.createElement(CheckAndPrintBox, {
  ...
  }, React__default.createElement(navFrontendTypografi.Normaltekst, null, React__default.createElement(CheckDateAndPrint, {
...
var Historikk = function Historikk(props) {
  ...
  var _useState = React.useState(props.arbeidsavtaler.map(function (arbeidsavtale) {
    return {
      arbeidsavtale: arbeidsavtale,
      ekspandert: false
    };
  ...
  return React__default.createElement("div", {
  ...
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].yrke)), React__default.createElement("div", {
    className: "af-detaljert__flex-kolonne"
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].periode)), React__default.createElement("div", {
    className: "af-detaljert__flex-kolonne"
    ...
    return React__default.createElement(React.Fragment, {
      ...
      onClick: onClick
    }, !ekspandert ? React__default.createElement("span", null, sprak[locale].apne, " ", React__default.createElement(navFrontendChevron.NedChevron, null)) : React__default.createElement("span", null, sprak[locale].lukke, " ", React__default.createElement(navFrontendChevron.OppChevron, null)))), ekspandert && React__default.createElement("div", {
      className: "af-detaljert__flex-rad"
    }, React__default.createElement("div", {
      className: "af-detaljert__flex-kolonne"
    }, React__default.createElement("div", {
      className: "af-detaljert__innhold"
    }, React__default.createElement(ArbeidsavtaleFelter, {
      locale: locale,
      data: arbeidsavtale
    })))));
  }));
...
var Permisjon = function Permisjon(props) {
  ...
  return React__default.createElement("div", {
    ...
    className: "af-detaljert__flex-kolonne"
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].type)), React__default.createElement("div", {
    className: "af-detaljert__flex-kolonne"
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].periode)), React__default.createElement("div", {
    className: "af-detaljert__flex-kolonne"
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].prosent))), props.permisjoner.map(function (permisjon, i) {
    return React__default.createElement("div", {
      className: "af-detaljert__flex-rad",
      key: "".concat(permisjon.permisjonPermitteringId, "-").concat(i)
    }, React__default.createElement("div", {
      className: "af-detaljert__flex-kolonne af-detaljert__heading"
    }, permisjon.type), React__default.createElement("div", {
      className: "af-detaljert__flex-kolonne"
    }, React__default.createElement(CheckPeriodAndPrint, {
...
var Timer = function Timer(props) {
  ...
  return React__default.createElement("div", {
  ...
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].rapporteringsperiode)), React__default.createElement("div", {
    className: "af-detaljert__flex-kolonne"
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].opptjeningsperiode)), React__default.createElement("div", {
    className: "af-detaljert__flex-kolonne"
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].antalltimer))), Object.keys(data).reverse().map(function (year) {
    var value = data[year];
    ...
    return React__default.createElement(React.Fragment, {
      ...
      className: "af-detaljert__flex-kolonne af-liste__ekspander",
      onClick: onClick
    }, year, " ", value.ekspandert ? React__default.createElement(navFrontendChevron.OppChevron, null) : React__default.createElement(navFrontendChevron.NedChevron, null)), React__default.createElement("div", null)), value.ekspandert && value.timerObjekt.map(function (time, i) {
      return React__default.createElement("div", {
        className: "af-detaljert__flex-rad",
        key: "".concat(i)
      }, React__default.createElement("div", {
        className: "af-detaljert__flex-kolonne af-liste__month af-detaljert__heading"
      }, time.periode && React__default.createElement(CheckDateAndPrint, {
...
var Utenlandsopphold = function Utenlandsopphold(props) {
  ...
  return React__default.createElement("div", {
    ...
    className: "af-detaljert__flex-kolonne"
  }, React__default.createElement(navFrontendTypografi.Element, null, sprak[locale].land))), Object.keys(data).reverse().map(function (year) {
    var value = data[year];
    ...
    return React__default.createElement(React.Fragment, {
      ...
      className: "af-detaljert__flex-kolonne af-liste__ekspander",
      onClick: onClick
    }, year, " ", value.ekspandert ? React__default.createElement(navFrontendChevron.OppChevron, null) : React__default.createElement(navFrontendChevron.NedChevron, null)), React__default.createElement("div", null)), value.ekspandert && value.opphold.map(function (time, i) {
      return React__default.createElement("div", {
        className: "af-detaljert__flex-rad",
        key: "".concat(i)
      }, React__default.createElement("div", {
        className: "af-detaljert__flex-kolonne af-liste__month  af-detaljert__heading"
      }, React__default.createElement(CheckDateAndPrint, {
...
var Arbeidsforhold$1 = function Arbeidsforhold(props) {
  ...
  var _useState = React.useState(tabs.length > 0 ? tabs[0].label : "Ugyldig tab"),
      _useState2 = _slicedToArray(_useState, 2),
      visTab = _useState2[0],
  ...
  return React__default.createElement("div", {
  ...
  }, React__default.createElement(navFrontendTypografi.Undertittel, null, React__default.createElement(ArbeidsgiverTittel, {
    overskrift: true,
    arbeidsgiver: arbeidsforhold.arbeidsgiver
  })), arbeidsforhold.arbeidsgiver.type === "Organisasjon" && React__default.createElement("div", {
    className: "af-detaljert__orgnr"
  }, React__default.createElement(navFrontendTypografi.Normaltekst, null, React__default.createElement(CheckAndPrint, {
    data: orgnr(arbeidsforhold.arbeidsgiver.orgnr),
    format: "".concat(sprak[locale].organisasjonsnummer, " %s")
  }))))), arbeidsforhold.ansettelsesperiode && React__default.createElement("div", {
    className: "af-detaljert__kolonne af-detaljert__periode"
  }, React__default.createElement("div", {
    className: "af-detaljert__arbeidsgiver"
  }, React__default.createElement(navFrontendTypografi.Undertittel, null, React__default.createElement("span", {
    className: "typo-element"
  }, sprak[locale].ansettelsesperiode)), React__default.createElement("div", {
    className: "af-detaljert__orgnr"
  }, React__default.createElement(navFrontendTypografi.Normaltekst, null, React__default.createElement(CheckPeriodAndPrint, {
    data: arbeidsforhold.ansettelsesperiode.periode
  })))))), React__default.createElement("hr", null), React__default.createElement("div", {
    className: "af-detaljert__innhold"
  }, arbeidsforhold.opplysningspliktigarbeidsgiver.type === "Organisasjon" && React__default.createElement(CheckAndPrintBox, {
    ...
    date: true
  })), tabs.length > 0 && React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
  ...
  }), tabs.length > 1 ? React__default.createElement(navFrontendSkjema.Select, {
    label: "",
  ...
  })) : React__default.createElement(navFrontendTypografi.Element, null, tabs[0].label)), function () {
    switch (visTab) {
      ...
      case sprak[locale].tabs.permisjonpermittering:
        return React__default.createElement(Permisjon, {
          permisjoner: permisjonPermittering,
          locale: locale
        });

      case sprak[locale].tabs.arbeidiutlandet:
        return React__default.createElement(Utenlandsopphold, {
          utenlandsopphold: utenlandsopphold,
          locale: locale
        });

      case sprak[locale].tabs.historikk:
        return React__default.createElement(Historikk, {
          arbeidsavtaler: arbeidsavtaler,
          locale: locale
        });
  ...
  }()), React__default.createElement(AlertStripe.AlertStripeInfo, null, sprak[locale].hvisfeil1, React__default.createElement("br", null), sprak[locale].hvisfeil2));
};
...
var DetaljertArbeidsforhold = function DetaljertArbeidsforhold(props) {
  ...
  switch (state.status) {
    ...
    case "RESULT":
      return React__default.createElement(Arbeidsforhold$1, _extends({
        arbeidsforhold: state.arbeidsforhold
      }, props));
...
exports.DetaljertArbeidsforhold = DetaljertArbeidsforhold;
exports.ListeMedArbeidsforhold = ListeMedArbeidsforhold;
exports.default = ListeMedArbeidsforhold;
